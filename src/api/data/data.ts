...
/**
 * Сохранение картинок вида base64 локально в папку media и показания датчика в таблицу indicator-values.
 */
...
export const getDataSavePhotoCreateMutationOptions = <TError = CreatePhoto | ErrorResponse401 | ErrorResponse405 | ErrorResponse406 | ErrorResponse415 | ErrorResponse500,
 ...
 const {mutation: mutationOptions, request: requestOptions} = options ?? {};
   ...
   return  { mutationFn, ...mutationOptions }}
    ...
    export type DataSavePhotoCreateMutationError = CreatePhoto | ErrorResponse401 | ErrorResponse405 | ErrorResponse406 | ErrorResponse415 | ErrorResponse500

    export const useDataSavePhotoCreate = <TError = CreatePhoto | ErrorResponse401 | ErrorResponse405 | ErrorResponse406 | ErrorResponse415 | ErrorResponse500,
